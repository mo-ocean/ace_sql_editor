<template>
  <div class="ace-container">
    <div class="ace-editor" style="height:500px;font-size:18px" ref="ace"></div>
    ...
    <button @click="fma">格式化</button>
    <button @click="query">查询语句</button>
...
export default {
  ...
  data() {
    return {
      ...
      modePath: "ace/mode/mysql",
      // modePath: "ace/mode/sqlserver",
      modeArray: modeArray,
      wrapArray: wrapArray,
      data:[
        {
  ...
  methods: {
    ...
    fma() {
      ...
      console.log(code)
      this.aceEditor.setValue(sqlFormatter.format(code))
